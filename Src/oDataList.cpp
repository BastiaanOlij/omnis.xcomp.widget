...
ECOproperty oDataListProperties[] = {
	...
	anumListName, 0, fftCharacter, EXTD_FLAG_FAR_SRCH + EXTD_FLAG_PROPGENERAL, 0, 0, 0, // $listname
	...
	oDL_columncalcs, 4111, fftCharacter, EXTD_FLAG_PROPDATA + EXTD_FLAG_PWINDMLINE + EXTD_FLAG_FAR_SRCH, 0, 0, 0, // $columncalcs
	...
	oDL_selectColor, 4118, fftInteger, EXTD_FLAG_PROPAPP + EXTD_FLAG_PWINDCOL, 0, 0, 0, // $selectcolor

	oDL_groupcalcs, 4120, fftCharacter, EXTD_FLAG_PROPDATA + EXTD_FLAG_PWINDMLINE + EXTD_FLAG_FAR_SRCH, 0, 0, 0, // $groupcalcs
	...
	oDL_parentCalcs, 4124, fftCharacter, EXTD_FLAG_PROPDATA + EXTD_FLAG_PWINDMLINE + EXTD_FLAG_FAR_SRCH, 0, 0, 0, // $parentCalcs

	oDL_filtercalc, 4122, fftCharacter, EXTD_FLAG_PROPDATA + EXTD_FLAG_FAR_SRCH, 0, 0, 0, // $filtercalc
};
